...
| 🏗️ **[PROJECT_STRUCTURE.md](docs/PROJECT_STRUCTURE.md)** | Подробное описание структуры проекта |

### 💾 SQL документация (новое!)
| Документ | Описание |
|----------|---------|
| 📰 **[SQL_DOCUMENTATION_INDEX.md](docs/SQL_DOCUMENTATION_INDEX.md)** | **НАЧНИТЕ ОТСЮДА** — навигационный центр для SQL |
| 📖 **[SQL_GUIDE.md](docs/SQL_GUIDE.md)** | Полный справочник: 6 таблиц, структура, 50+ примеров SQL |
| ⚡ **[SQL_CHEATSHEET.md](docs/SQL_CHEATSHEET.md)** | Быстрая шпаргалка: таблицы команд, синтаксис, условия |
| 🛒 **[PRACTICAL_SQL_EXAMPLES.md](docs/PRACTICAL_SQL_EXAMPLES.md)** | 70+ готовых примеров: импорт, заказы, статистика |
| 📐 **[DATABASE_SCHEMA.md](docs/DATABASE_SCHEMA.md)** | ER-диаграмма, схема таблиц, связи, индексы |
| 🖥️ **[GUI_TOOLS_GUIDE.md](docs/GUI_TOOLS_GUIDE.md)** | Как работать через DBeaver, pgAdmin, VS Code |
| 📊 **[SQL_DOCUMENTATION_OVERVIEW.md](docs/SQL_DOCUMENTATION_OVERVIEW.md)** | Обзор всех SQL документов и как они связаны |

---

## � SQL И БАЗА ДАННЫХ

### Быстрое введение в SQL для этого проекта

Если вы хотите работать с базой данных PostgreSQL:

**➡️ НАЧНИТЕ ОТВЕТ: [SQL_DOCUMENTATION_INDEX.md](SQL_DOCUMENTATION_INDEX.md)** 

**Развиватиции для каждого:**
- 👶 **Новичок в SQL?** → [SQL_GUIDE.md](SQL_GUIDE.md) (полный курс с объяснениями)
- 😎 **Знаю SQL, нужна справка?** → [SQL_CHEATSHEET.md](SQL_CHEATSHEET.md) (быстрые таблицы)
- 🔧 **Нужен пример для задачи?** → [PRACTICAL_SQL_EXAMPLES.md](PRACTICAL_SQL_EXAMPLES.md) (70+ готовых примеров)
- 📊 **Хочу понять структуру?** → [DATABASE_SCHEMA.md](DATABASE_SCHEMA.md) (диаграмма и отношения)
- 🎨 **Не хочу писать SQL?** → [GUI_TOOLS_GUIDE.md](GUI_TOOLS_GUIDE.md) (DBeaver, pgAdmin)

**Статистика документации:**
- 530+ KB документации
- 150+ примеров SQL
- 7 файлов (навигация + 6 документов)
- На русском языке
